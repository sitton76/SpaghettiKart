...
{
    gsSPDisplayList(d_course_toads_turnpike_dl_1BD48),
    gsSPDisplayList(d_course_toads_turnpike_dl_1BC78),
    gsSPDisplayList(d_course_toads_turnpike_dl_1B8A0),
    gsSPDisplayList(d_course_toads_turnpike_dl_1B810),
    gsSPDisplayList(d_course_toads_turnpike_dl_1B788),
    gsSPEndDisplayList(),
};
...
{
    gsSPDisplayList(d_course_toads_turnpike_dl_1FF50),
    gsSPDisplayList(d_course_toads_turnpike_dl_1FEC8),
    gsSPDisplayList(d_course_toads_turnpike_dl_1FE50),
    gsSPDisplayList(d_course_toads_turnpike_dl_1FDD0),
    gsSPDisplayList(d_course_toads_turnpike_dl_1FD58),
    gsSPDisplayList(d_course_toads_turnpike_dl_1FCD8),
    gsSPDisplayList(d_course_toads_turnpike_dl_1F9E0),
    gsSPEndDisplayList(),
};
...
Gfx d_course_toads_turnpike_dl_21DD8[] =
{
    ...
    gsSPDisplayList(d_course_toads_turnpike_dl_21D28),
    gsSPDisplayList(d_course_toads_turnpike_dl_21CD0),
    gsSPDisplayList(d_course_toads_turnpike_dl_21C78),
    gsSPDisplayList(d_course_toads_turnpike_dl_21A28),
    gsSPDisplayList(d_course_toads_turnpike_dl_21950),
    gsSPDisplayList(d_course_toads_turnpike_dl_218B0),
    gsSPDisplayList(d_course_toads_turnpike_dl_21820),
    gsSPDisplayList(d_course_toads_turnpike_dl_21790),
    gsSPEndDisplayList(),
};
